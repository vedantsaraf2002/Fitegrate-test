...
class HipCircle extends StatefulWidget {
  const HipCircle({Key? key}) : super(key: key);

  @override
  _HipCircleState createState() => _HipCircleState();
}

class _HipCircleState extends State<HipCircle> {
        ...
        children: [
          ...
          Center(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(10, 6, 10, 0),
              child: Text(
                "Perform 10 rounds in each direction",
                style: TextStyle(
                    color: Colors.black87,
                    fontSize: 18,
