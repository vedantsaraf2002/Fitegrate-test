...
class WalkingKneeHugs extends StatefulWidget {
  const WalkingKneeHugs({Key? key}) : super(key: key);

  @override
  _WalkingKneeHugsState createState() => _WalkingKneeHugsState();
}

class _WalkingKneeHugsState extends State<WalkingKneeHugs> {
        ...
        children: [
          ...
          Center(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(10, 6, 10, 0),
              child: Text(
                "Perform 7 rounds in each direction",
                style: TextStyle(
                    color: Colors.black87,
                    fontSize: 18,
