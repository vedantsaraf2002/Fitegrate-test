...
class WalkingHip extends StatefulWidget {
  const WalkingHip({Key? key}) : super(key: key);

  @override
  _WalkingHipState createState() => _WalkingHipState();
}

class _WalkingHipState extends State<WalkingHip> {
