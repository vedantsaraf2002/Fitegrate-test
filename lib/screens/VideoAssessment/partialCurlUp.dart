...
class VideoAssessmentPartialCurlUp extends StatefulWidget {
  const VideoAssessmentPartialCurlUp({ Key? key }) : super(key: key);

  @override
  _VideoAssessmentPartialCurlUpState createState() => _VideoAssessmentPartialCurlUpState();
}

class _VideoAssessmentPartialCurlUpState extends State<VideoAssessmentPartialCurlUp> {
 ...
 Row(
            ...
            child: IconButton(
              onPressed: () {
                Navigator.pushNamed(context, 'VideoAssessmentPushUp');
              },
